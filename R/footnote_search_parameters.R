#' Create a new FootnoteSearchParameters
#'
#' @description
#' FootnoteSearchParameters Class
#'
#' @docType class
#' @title FootnoteSearchParameters
#' @description FootnoteSearchParameters Class
#' @format An \code{R6Class} generator object
#' @field pageParameters  \link{FootnoteQueryParameters} [optional]
#' @field periodParameters  \link{FootnotePeriodParameters} [optional]
#' @field companiesParameters  \link{CompaniesParameters} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
FootnoteSearchParameters <- R6::R6Class(
  "FootnoteSearchParameters",
  public = list(
    `pageParameters` = NULL,
    `periodParameters` = NULL,
    `companiesParameters` = NULL,
    #' Initialize a new FootnoteSearchParameters class.
    #'
    #' @description
    #' Initialize a new FootnoteSearchParameters class.
    #'
    ...
    #' To JSON String
    #'
    #' @return FootnoteSearchParameters in JSON format
    #' @export
    toJSON = function() {
      FootnoteSearchParametersObject <- list()
      if (!is.null(self$`pageParameters`)) {
        FootnoteSearchParametersObject[["pageParameters"]] <-
          self$`pageParameters`$toJSON()
      }
      if (!is.null(self$`periodParameters`)) {
        FootnoteSearchParametersObject[["periodParameters"]] <-
          self$`periodParameters`$toJSON()
      }
      if (!is.null(self$`companiesParameters`)) {
        FootnoteSearchParametersObject[["companiesParameters"]] <-
          self$`companiesParameters`$toJSON()
      }
      FootnoteSearchParametersObject
    },
    #' Deserialize JSON string into an instance of FootnoteSearchParameters
    #'
    #' @description
    #' Deserialize JSON string into an instance of FootnoteSearchParameters
    #'
    #' @param input_json the JSON input
    #' @return the instance of FootnoteSearchParameters
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`pageParameters`)) {
        `pageparameters_object` <- FootnoteQueryParameters$new()
      ...
      if (!is.null(this_object$`periodParameters`)) {
        `periodparameters_object` <- FootnotePeriodParameters$new()
    ...
    fromJSONString = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      self$`pageParameters` <- FootnoteQueryParameters$new()$fromJSON(jsonlite::toJSON(this_object$`pageParameters`, auto_unbox = TRUE, digits = NA))
      self$`periodParameters` <- FootnotePeriodParameters$new()$fromJSON(jsonlite::toJSON(this_object$`periodParameters`, auto_unbox = TRUE, digits = NA))
    ...
    #' Validate JSON input with respect to FootnoteSearchParameters
    #'
    #' @description
    #' Validate JSON input with respect to FootnoteSearchParameters and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of FootnoteSearchParameters
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# FootnoteSearchParameters$unlock()
#
## Below is an example to define the print function
# FootnoteSearchParameters$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# FootnoteSearchParameters$lock()
