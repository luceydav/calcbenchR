...
#'
#' @docType class
#' @title DimensionalData operations
#' @description DimensionalDataApi
#' @format An \code{R6Class} generator object
#' @field api_client Handles the client-server communication.
#'
#' @section Methods:
#' \describe{
#' \strong{ DimensionalDataDimensionalData } \emph{ The data behind https://www.calcbench.com/segments }
#'
#' \itemize{
#' \item \emph{ @param } params \link{DimensionalSearchParameters}
#' \item \emph{ @returnType } list( \link{DimensionalDataPoint} ) \cr
#'
#'
#' \item status code : 200 | OK
#'
#' \item return type : array[DimensionalDataPoint]
...
#' @export
DimensionalDataApi <- R6::R6Class(
  "DimensionalDataApi",
  public = list(
    api_client = NULL,
    #' Initialize a new DimensionalDataApi.
    #'
    #' @description
    #' Initialize a new DimensionalDataApi.
    #'
    ...
    #' @export
    DimensionalDataDimensionalData = function(params, data_file = NULL, ...) {
      local_var_response <- self$DimensionalDataDimensionalDataWithHttpInfo(params, data_file = data_file, ...)
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (array[DimensionalDataPoint]) with additional information such as HTTP status code, headers
    #' @export
    DimensionalDataDimensionalDataWithHttpInfo = function(params, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/api/dimensionalData"
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "array[DimensionalDataPoint]", loadNamespace("calcbenchR")),
          error = function(e) {
